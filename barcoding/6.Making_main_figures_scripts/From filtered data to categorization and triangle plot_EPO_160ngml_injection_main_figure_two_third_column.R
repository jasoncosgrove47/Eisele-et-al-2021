...
##### 0 Import data
x1<-read.table("/Users/almut/Dropbox/Eisele_et_al_EPO/github_paper/barcoding/5.Filtered_barcoding_data/EPO_160ngml+injection_all_filtered_EPO_7_8_Ctrl_1_2_3_4.txt", sep="\t", header=TRUE)
...
H5<- cbind(x1[,1],H5)
H6 <- x1[,grep("_8_", colnames(x1))]
H6<- cbind(x1[,1],H6)

Hmouse<-list(H1, H2, H3, H4, H5, H6)
...
HBimouse<-list(HBi1, HBi2, HBi3, HBi4, HBi5, HBi6)
...
HBiimouse<-list(HBii1, HBii2, HBii3, HBii4, HBii5, HBii6)
...
NORM<-gdata::combine(H1, H2, H3, H4, H5, H6)
